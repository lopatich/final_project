...
#separating channels for playing different sounds
...
def music_start():
    theme_sound = pygame.mixer.Sound('maintheme.wav')
    channel1.play(theme_sound, -1)

def boom():
    boom_sound = pygame.mixer.Sound('boom.wav')
    channel2.play(boom_sound)

def starter_sound():
    start_sound = pygame.mixer.Sound('start.wav')
    channel3.play(start_sound)

def win_sound():
    win_sound = pygame.mixer.Sound('win.wav')
    channel4.play(win_sound)

def gameover_sound():
    gameover_sound = pygame.mixer.Sound('gameover.wav')
    channel5.play(gameover_sound) 
